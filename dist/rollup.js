/*
  @license
	Rollup.js v1.26.3
	Mon, 11 Nov 2019 17:58:13 GMT - commit 329733435fb97e5d812ac099c55ec6163c06b239
    ...
    parseNode(esTreeNode) {
        for (const key of Object.keys(esTreeNode)) {
            ...
            if (typeof value !== 'object' || value === null || key === 'annotations') {
                // TODO this sets the other properties such as type, start, end
                this[key] = value;
            }
                ...
                // TODO this assumes that the key holds a child node (or array) which will have a type
